...
tellraw @a ["",{"color":"gold","bold":true,"text":"<DrinkingCraft> "},{"color":"dark_gray","bold":false,"selector":"@p"},{"color":"dark_gray","bold":false,"text":" was the first to find a mushroom island biome; something very useful for everyone, so everyone must take a sip of their drinks, except "},{"color":"dark_gray","bold":false,"selector":"@p"},{"color":"dark_gray","bold":false,"text":"!"}]

scoreboard players set $global ksr.mushroom 0
